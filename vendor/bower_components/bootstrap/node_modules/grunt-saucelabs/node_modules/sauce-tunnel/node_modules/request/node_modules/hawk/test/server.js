        ...
        describe('#authenticate', function () {
            ...
            it('should parse a valid authentication header (sha256)', function (done) {
                ...
                var req = {
                    ...
                    host: 'example.com',
                    port: 8000,
                    authorization: 'Hawk id="dh37fgj492je", ts="1353832234", nonce="j4h3g2", mac="m8r1rHbXN6NgO+KIIhjO7sFRyd78RNGVUwehe8Cp2dU=", ext="some-appbd-data"',
                };
            ...
            it('should parse a valid authentication header (POST with payload)', function (done) {
                ...
                var req = {
                    ...
                    host: 'example.com',
                    port: 8080,
                    authorization: 'Hawk id="123456", ts="1357926341", nonce="1AwuJD", hash="qAiXIVv+yjDATneWxZP2YCTa9aHRgQdnH9b3Wc+o3dg=", ext="some-appbd-data", mac="UeYcj5UoTVaAWXNvJfLVia7kU3VabxCqrccXP8sUGC4="',
                };
            ...
            it('should fail on a stale timestamp', function (done) {
                ...
                var req = {
                    ...
                    host: 'example.com',
                    port: 8080,
                    authorization: 'Hawk id="123456", ts="1362337299", nonce="UzmxSs", ext="some-appbd-data", mac="wnNUxchvvryMH2RxckTdZ/gY3ijzvccx4keVvELC61w="',
                };
