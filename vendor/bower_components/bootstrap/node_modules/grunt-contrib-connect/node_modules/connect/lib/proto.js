 ...
 *
 *      var appbd = connect();
 *      appbd.use(connect.favicon());
 *      appbd.use(connect.logger());
 *      appbd.use(connect.static(__dirname + '/public'));
 *
 * If we wanted to prefix static files with _/public_, we could
 * "mount" the `static()` middleware:
 *
 *      appbd.use('/public', connect.static(__dirname + '/public'));
 *
 ...
 *      var appbd = connect();
 *
 *      http.createServer(appbd).listen(80);
 *      https.createServer(options, appbd).listen(443);
 *
 * @return {http.Server}
 * @api public
 */
