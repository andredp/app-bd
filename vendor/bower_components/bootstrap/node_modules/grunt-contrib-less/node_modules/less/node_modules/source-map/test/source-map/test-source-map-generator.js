...
define(function (require, exports, module) {
  ...
  exports['test the two additional parameters of applySourceMap'] = function (assert, util) {
    ...
    util.assertEqualMaps(assert, actualMap('/appbd/temp/temp_maps'), expectedMap([
      '/appbd/coffee/foo.coffee',
      '/bar.coffee',
      'http://www.example.com/baz.coffee'
    ]));

    util.assertEqualMaps(assert, actualMap('http://foo.org/appbd/temp/temp_maps'), expectedMap([
      'http://foo.org/appbd/coffee/foo.coffee',
