    ...
    describe('Uri', function () {
        ...
        it('should generate a bewit then successfully authenticate it', function (done) {
            ...
            credentialsFunc('123456', function (err, credentials) {
                ...
                var bewit = Hawk.uri.getBewit('http://example.com/resource/4?a=1&b=2', { credentials: credentials, ttlSec: 60 * 60 * 24 * 365 * 100, ext: 'some-appbd-data' });
                req.url += '&bewit=' + bewit;
                ...
                Hawk.uri.authenticate(req, credentialsFunc, {}, function (err, credentials, attributes) {
                    ...
                    expect(attributes.ext).to.equal('some-appbd-data');
                    done();
                });
            });
        });
